...
exports.MARKDOWN_ELEMENTS = void 0;
exports.getElementsByGroup = getElementsByGroup;
exports.getElementById = getElementById;
exports.MARKDOWN_ELEMENTS = [
    // ── Headings ────────────────────────────────────────────────────────────────
    {
...
function getElementsByGroup() {
    const map = new Map();
    for (const el of exports.MARKDOWN_ELEMENTS) {
        if (!map.has(el.group)) {
            map.set(el.group, []);
        }
...
function getElementById(id) {
    return exports.MARKDOWN_ELEMENTS.find(el => el.id === id);
}
