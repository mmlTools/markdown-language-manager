...
import { MARKDOWN_ELEMENTS, MarkdownElement } from './markdownElements';
...
export class MarkdownCompletionProvider implements vscode.CompletionItemProvider {
    ...
    private makeItem(label: string, insertText: string, kind: vscode.CompletionItemKind, detail?: string): vscode.CompletionItem {
    ...
    private makeSnippetItem(label: string, snippet: string, detail: string, kind: vscode.CompletionItemKind): vscode.CompletionItem {
        const item = new vscode.CompletionItem(label, kind);
    ...
    private makeCodeBlockItem(): vscode.CompletionItem {
    ...
    private makeTableItem(cols: number): vscode.CompletionItem {
    ...
    private toSnippet(el: MarkdownElement): string {
