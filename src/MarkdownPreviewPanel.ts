...
import { renderMarkdownToHtml } from './MarkdownToolbarViewProvider';
...
function getPreviewHtml(webview: vscode.Webview, content: string, title: string): string {
...
export class MarkdownPreviewPanel {
    ...
    private static readonly _viewType = 'markdownManager.preview';
    ...
    public static createOrShow(extensionUri: vscode.Uri): void {
        ...
        if (MarkdownPreviewPanel.currentPanel) {
            MarkdownPreviewPanel.currentPanel._panel.reveal(
                column === vscode.ViewColumn.One ? vscode.ViewColumn.Two : vscode.ViewColumn.Beside
            );
        ...
        const panel = vscode.window.createWebviewPanel(
            MarkdownPreviewPanel._viewType,
            'Markdown Preview',
    ...
    private _update(): void {
        ...
        if (document && document.languageId === 'markdown') {
            html = renderMarkdownToHtml(document.getText());
        } else {
    ...
    private _updateContent(): void {
        ...
        const html = renderMarkdownToHtml(editor.document.getText());
